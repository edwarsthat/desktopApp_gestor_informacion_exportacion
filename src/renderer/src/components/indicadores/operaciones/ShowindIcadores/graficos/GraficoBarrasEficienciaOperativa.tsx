...
//                 }
//             });
//             chartRef.current.data.datasets[0].data = props.data.map(item => item.kilos_procesados);
//             chartRef.current.data.datasets[1].data = props.data.map(item => item.meta_kilos_procesados - item.kilos_procesados);
...
//                                     type: 'bar',
//                                     data: props.data.map(item => item.kilos_procesados),
...
//                                     label: 'Meta Kilos',
//                                     type: 'bar',
//                                     data: props.data.map(item => item.meta_kilos_procesados - item.kilos_procesados),
